...
int main () {
	...
	for (int i=0;i<s.size();i++) {
		...
		else if (s[i]=='j'||s[i]=='J') cout << "_|";
		else if (s[i]=='k'||s[i]=='K') cout << "|<";
		else if (s[i]=='l'||s[i]=='L') cout << "1";
		else if (s[i]=='m'||s[i]=='M') cout << "[]\\/[]";
		else if (s[i]=='n'||s[i]=='N') cout << "[]\\[]";
		else if (s[i]=='o'||s[i]=='O') cout << "0";
		else if (s[i]=='p'||s[i]=='P') cout << "|D";
		else if (s[i]=='q'||s[i]=='Q') cout << "(,)";
		else if (s[i]=='r'||s[i]=='R') cout << "|Z";
		else if (s[i]=='s'||s[i]=='S') cout << "$";
		else if (s[i]=='t'||s[i]=='T') cout << "']['";
		else if (s[i]=='u'||s[i]=='U') cout << "|_|";
